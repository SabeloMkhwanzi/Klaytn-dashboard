...
export default function ClaimswapTransactionsTable({ data }) {
        ...
        <td>
          <Tooltip label="Klaytn Scope">
            <Text
              ...
              target="_blank"
              variant="subtle"
              href={`https://scope.klaytn.com/account/${index.sender_address}?tabId=txList`}
            >
              <Group>
