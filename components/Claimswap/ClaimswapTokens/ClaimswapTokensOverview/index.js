...
import ClaimswapTokensOverviewTable from "./ClaimswapTokensOverviewTable";
...
export default function ClaimswapTokensOverview() {
  // used React-Query to fetch Covalent API
  const { data, error, isFetching } = useQuery(
    ["claimswapTokensOverview"],
    async () => {
  ...
  return (
    <Box>
      <Box minWidth="1220" maxW="600" justifyItems="center" mx="auto" mb={20}>
        ...
        <ClaimswapTokensOverviewTable data={items} />
      </Box>
    </Box>
  );
}
